...
@Component({
  selector: 'app-individual-index',
  templateUrl: './individual-index.component.html',
  styleUrls: ['./individual-index.component.scss']
})
export class IndividualIndexComponent implements OnInit {
  ...
  displayEditForm(id: number): void {
    this.router.navigate([`/individuals/${id}/edit`]);
  }
  ...
  ngOnInit(): void {
    this.dtService.initDt('client_individual').toPromise()   // Get Dt options from back by code_name
      .then((response) => {
